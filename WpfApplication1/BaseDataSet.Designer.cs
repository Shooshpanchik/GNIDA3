...
namespace WpfApplication1.BaseDataSetTableAdapters {
    ...
    public partial class proceduresTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[procedures] WHERE (([Addr] = @Original_Addr) AND ((@IsNull_typ" +
                "e = 1 AND [type] IS NULL) OR ([type] = @Original_type)) AND ((@IsNull_end = 1 AN" +
                "D [end] IS NULL) OR ([end] = @Original_end)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[procedures] ([Addr], [Name], [type], [end]) VALUES (@Addr, @Na" +
                "me, @type, @end);\r\nSELECT Addr, Name, type, [end] FROM procedures WHERE (Addr = " +
                "@Addr)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[procedures] SET [Addr] = @Addr, [Name] = @Name, [type] = @type, [end] = @end WHERE (([Addr] = @Original_Addr) AND ((@IsNull_type = 1 AND [type] IS NULL) OR ([type] = @Original_type)) AND ((@IsNull_end = 1 AND [end] IS NULL) OR ([end] = @Original_end)));
SELECT Addr, Name, type, [end] FROM procedures WHERE (Addr = @Addr)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Addr, Name, type, [end] FROM dbo.procedures";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        Name\r\nFROM            procedures\r\nWHERE        (Addr <= @Param1)and" +
                "([end]>@Param1)";
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual object GetFuncAddr(long Param1) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual object ScalarQuery(long Param1) {
